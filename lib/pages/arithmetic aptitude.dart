...
import 'package:aspirearc/models/sample_questions.dart';
import 'result_screen.dart';

typedef OnSubmit = void Function(double score, double timeElapsed);

class ArithmeticAptitudePage extends StatefulWidget {
  final OnSubmit onSubmit;

  const ArithmeticAptitudePage({super.key, required this.onSubmit});

  @override
  _ArithmeticAptitudePageState createState() => _ArithmeticAptitudePageState();
}

class _ArithmeticAptitudePageState extends State<ArithmeticAptitudePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Arithmetic Aptitude'),
      ),
      body: Padding(
